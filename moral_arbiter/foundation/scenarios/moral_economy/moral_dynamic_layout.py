...
from moral_arbiter.foundation.base.base_env import BaseEnvironment, scenario_registry
from moral_arbiter.foundation.scenarios.utils import rewards, social_metrics


@scenario_registry.add
class MoralUniform(BaseEnvironment):
    """
    World containing spatially-segregated stone and wood with stochastic regeneration.
    Agents have moral, amoral, or immoral reward functions.
    ...
    For controlling how agents behave...
        moral theory: Utilitarianism or Virtue Ethics.
        Agent's morality: a number from [-1, 1] entailing how moral an agent is. 
        In Utilitarianism, the agent's morality determines how much they care about others.
        In virtue ethics, it determines how okay they were with commiting a negative action.
    ...
    Args:
        ...
        moral_theory: (str): The type of moral theory for the agents to use. Options 
            are "amoral", "utilitarian", "virtue ethics"
    ...
    name = "moral_uniform/simple_wood_and_stone"
...
class Quadrant(MoralUniform):
    ...
    required_entities = MoralUniform.required_entities + ["Water"]
