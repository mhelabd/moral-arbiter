...
from moral_arbiter.foundation.agents import agent_registry
from moral_arbiter.foundation.base.registrar import Registry
from moral_arbiter.foundation.base.world import World
from moral_arbiter.foundation.components import component_registry
from moral_arbiter.foundation.entities import (
    endogenous_registry,
    landmark_registry,
    resource_registry,
)
...
class BaseEnvironment(ABC):
    """
    TODO: Add level of Morality and Style of Morality to args
    ...
    Example:
        from moral_arbiter import foundation
        from moral_arbiter.foundation.base.base_env import BaseEnvironment
...
Example:
    from moral_arbiter.foundation.base.base_env
